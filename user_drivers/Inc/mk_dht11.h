...
struct _dht11_t{
	...
	uint8_t temperature_I; ///Integral Temperature value
	uint8_t humidty_I; ///Integral humidity value
	uint8_t temperature_D; ///Decimal Temperature value
	uint8_t humidty_D; ///Decimal humidity value
};
